...
# Windows: ~\AppData\Local\arrnorm\python<xy>
# macOS: ~/Library/Application Support/arrnorm/python<xy>
# Linux: ~/.local/share/arrnorm/python<xy>
...
INSTALL_PREFIX = os.path.join(DATA_HOME, 'arrnorm', 'python' + ''.join(PY_MAJORMINOR))
